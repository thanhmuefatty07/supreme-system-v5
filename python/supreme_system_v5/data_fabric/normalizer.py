...
class DataNormalizer:
    ...
    def normalize(self, source: str, raw_data: Dict[str, Any]) -> Optional[MarketDataPoint]:
        """
    ...
    def _normalize_coingecko(self, data: Dict) -> MarketDataPoint:
        ...
        return MarketDataPoint(
            ...
            high_24h=float(data.get('price', 0)),  # CG simple API doesn't include high/low
    ...
    def _normalize_generic(self, data: Dict) -> MarketDataPoint:
        ...
        return MarketDataPoint(
            ...
            volume_24h=float(data.get('volume_24h', data.get('volume', data.get('vol', 0)))),
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'error_rate': self.normalization_stats['errors'] / max(1, self.normalization_stats['total_normalized']),
