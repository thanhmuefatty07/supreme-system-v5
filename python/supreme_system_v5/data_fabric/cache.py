...
class DataCache:
    ...
    def __init__(self, redis_url: str = None, postgres_url: str = None):
        ...
        self.postgres_url = (
            postgres_url
            or "postgresql://postgres:supreme_password@localhost:5432/supreme_trading"
        )
    ...
    async def connect(self):
        ...
        try:
            ...
            if self.redis_url.startswith("redis://"):
                # Parse URL for synchronous connection
                # For now, use localhost defaults, will be configurable
    ...
    async def _set_redis(
        self, cache_key: str, data: MarketDataPoint, ttl_seconds: int = 300
    ):
        ...
        try:
            ...
            self.redis.setex(cache_key, ttl_seconds, json.dumps(data_dict))
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "hit_rate": (total_requests - self.stats["misses"])
    ...
    async def _cleanup_loop(self):
        ...
        while self.running:
            try:
                ...
                expired_keys = [
                    key
                    for key, ttl in self.cache.memory_ttl.items()
    ...
    def get_health(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "memory_usage_percent": (
                len(self.cache.memory_cache) / self.cache.max_memory_items
            )
            * 100,
            **stats,
        }
