...
class AuthConfig:
    ...
    def __post_init__(self):
        ...
        if len(self.jwt_secret_key) < 32:
            ...
            logger.warning("Generated new JWT secret key - ensure consistency across restarts")
...
class JWTManager:
    ...
    def generate_access_token(self, user: User, session_id: str = None) -> str:
    ...
    def generate_refresh_token(self, user: User, session_id: str) -> str:
        ...
        logger.info(f"🔄 Refresh token generated for user {user.username}")
        return token
    
    def verify_token(self, token: str, token_type: TokenType = None) -> TokenClaims:
...
class UserManager:
    ...
    def create_user(self, user: User, password: str) -> bool:
        ...
        try:
            ...
            logger.info(f"👤 User created: {user.username} ({user.role.value})")
            return True
    ...
    def authenticate_user(self, username: str, password: str) -> Optional[User]:
        ...
        try:
            ...
            if bcrypt.checkpw(password.encode('utf-8'), password_hash.encode('utf-8')):
                ...
                logger.warning(f"🚫 Failed login attempt {user.login_attempts}: {username}")
                return None
...
class AuthenticationManager:
    ...
    def __init__(self, config: AuthConfig = None):
        ...
        logger.info(f"   JWT expiration: {self.config.access_token_expire_minutes} minutes")
        logger.info(f"   Max login attempts: {self.config.max_login_attempts}")
    ...
    def refresh_access_token(self, refresh_token: str) -> Dict[str, Any]:
        ...
        try:
            ...
            access_token = self.jwt_manager.generate_access_token(user, claims.session_id)
    ...
    def logout(self, token: str):
        ...
        try:
            ...
            logger.info(f"👋 User logged out: {claims.sub}")
